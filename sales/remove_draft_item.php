<?php
// Prevent any accidental whitespace or HTML before JSON
ob_clean();
header('Content-Type: application/json');
header('Access-Control-Allow-Origin: *'); // optional if you use it in frontend
...
$draft_id = intval($data['draft_id']); // make sure it’s integer
