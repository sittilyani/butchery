                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="btn btn-update" onclick="location.href='../views/update_supplier.php?supplier_id=<?php echo $supplier['supplier_id']; ?>'">
                                    Update
                                </button>
                                <button class="btn btn-delete" onclick="if(confirm('Are you sure you want to delete this supplier?')) location.href='../views/delete_supplier.php?supplier_id=<?php echo $supplier['supplier_id']; ?>'">
                                    Delete
                                </button>
