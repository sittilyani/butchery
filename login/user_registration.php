...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($photo_blob) {
        $sql = "INSERT INTO users (username, first_name, last_name, email, password, sex, mobile, photo, userrole, status, date_created, created_by)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'active', NOW(), ?)";
        ...
        $sql = "INSERT INTO users (username, first_name, last_name, email, password, sex, mobile, userrole, status, date_created, created_by)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'Active', NOW(), ?)";
