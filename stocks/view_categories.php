...
<head>
    ...
    <style>
        .main-content {width: 40%; padding: 30px; margin-left: auto; margin-right: auto;}

        button{background-color:#000099;color:white;border:none;border-radius:5px;padding:8px 14px;font-size:14px;cursor:pointer;margin-bottom:15px}
        button a{color:white;text-decoration:none}
        table{width:100%;border-collapse:collapse;margin-top:10px}
        th,td{border:1px solid #dee2e6;padding:6px 10px;font-size:14px;text-align:left}
        th{background-color:#000099;color:white;height:50px}
        tr:nth-child(even){background-color:#f8f9fa}
        .action-buttons{display:flex;gap:5px;flex-wrap:wrap}
        .action-buttons button{padding:5px 10px;font-size:13px;display:flex;align-items:center;gap:5px}
        ...
        thead{display:none}
        tr{margin-bottom:10px;background-color:#fff;border:1px solid #ddd;border-radius:4px;padding:10px}
        td{border:none;padding:6px 10px;position:relative}
        td::before{content:attr(data-label);font-weight:bold;display:block;color:#6c757d}
